...
classdef optUW
    methods(Static)
        ...
        function [params,err] = fit(funName, params, freeList, varargin)
            ...
            % calling fminsearch
            vars = fminsearch(@optUW.fitfunc, vars, options, funName, params, freeList,varargin{:});
            ...
            err = optUW.fitfunc(vars, funName, params, freeList, varargin);
        end
        ...
        function err = fitfunc(vars, funName, params, freeList, varargin)
            params = optUW.var2params(vars, params, freeList);  % rebuild params struct
            err = feval(funName, params, varargin{:});          % evaluate error
        end
    end
end